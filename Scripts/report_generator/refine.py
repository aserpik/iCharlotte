...
def _get_section_specific_instructions(section_name: str) -> str:
    ...
    instructions = {
        ...
        "INVESTIGATION": (
            "=== SECTION STRUCTURE ===\n"
            "- Use descriptive sub-headings for each source of information:\n"
            "  witness names, documents reviewed, site inspections, related\n"
            "  litigation documents, etc.\n"
            "- Under each sub-heading, detailed narrative of findings.\n"
            "- Include ALL witness statements and document details.\n"
            "- If there are related litigation documents (lawsuits, court filings,\n"
            "  etc.), include them in a 'Related Litigation Documents' sub-heading."
        ),
        "DISCOVERY": (
            "=== SECTION STRUCTURE ===\n"
            "- Use sub-headings by responding party name (e.g., 'Plaintiff John Doe's Responses').\n"
        ...
        "EVALUATION OF LIABILITY": (
            ...
            "- Use NUMBERED sub-headings for legal elements:\n"
            "  1. Duty\n"
            "  2. Breach\n"
            "  3. Causation\n"
            "  4. Damages\n"
            "- If multiple causes of action, use named sub-headings for each\n"
            "  (e.g., 'Negligence (Against Both Defendants)', 'Negligent Entrustment').\n"
