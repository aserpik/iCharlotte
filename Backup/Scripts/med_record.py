...
# --- Configuration ---
LOG_FILE = r"C:\GeminiTerminal\Med_Record_activity.log"
PROMPT_FILE = r"C:\GeminiTerminal\Scripts\MED_RECORD_PROMPT.txt"
        ...
        for model_name in model_sequence:
                    log_event(f"Attempting to use model: {model_name}")
                            try:
                                ...
                                if response and response.text:                    log_event(f"Success with model: {model_name}")
